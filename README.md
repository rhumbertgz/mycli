...
running command...
$ mycli (--version)
mycli/0.0.0 darwin-arm64 node-v16.18.0
$ mycli --help [COMMAND]
USAGE
  $ mycli COMMAND
...
...
_See code: [dist/commands/hello/index.ts](https://github.com/rhumbertgz/mycli/blob/v0.0.0/dist/commands/hello/index.ts)_
